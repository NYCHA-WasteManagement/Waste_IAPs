...
\textbf{GLOSSARY CONTAINING KEY TERMS, EASILY MISUNDERSTOOD TERMS TO COME HERE}
\pagebreak
...
\textbf{An explanation of how these assets contribute to waste management is forthcoming.}
\begin{table}[H]
...
\textbf{Contextualizing text is forthcoming.}
\begin{table}[H]
...
%\begin{comment}
\includepdf[pages=1, angle=0, picturecommand*={\put(200,300){\textcolor{lightBlue}{Appendix I -- Site Plans}}}]{\rootpath/APPENDICES/SITE_PLANS/\tds_site_plans.pdf}
\includepdf[pages={2-}, angle=0]{\rootpath/APPENDICES/SITE_PLANS/\tds_site_plans.pdf}
%\end{comment}

%\textcolor{lightBlue}{Appendix I - Site Plans}
