\documentclass[11pt, letterpaper, final, table, xcdraw]{report}
...
\tikzstyle{arrow} = [thick,->,>=angle 60, draw=ccfuschia]
\tikzstyle{dotline} = [thick, dashed, draw=ccfuschia]
...
%%%%% Cover Page, Letter from Chair, and Description of Project
	...
	\input{\rootpath/TEXT/preface_text/preface_nosec}
	%\{about_the_project}
