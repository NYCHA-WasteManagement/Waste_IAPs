...
\sffamily
\fakechapter{Waste Services and Assets}
...
\begin{comment}
\includepdf[pages=1, angle=0, picturecommand*={\put(-600,-700){\textcolor{lightBlue}{Appendix I -- Site Plans}}}]{\rootpath/APPENDICES/SITE_PLANS/\tds_site_plans.pdf}
