        ...
        \cline{2-2}
        \multicolumn{1}{l|}{}                                                        & \cellcolor{ccorange}{\color[HTML]{FFFFFF}Roosevelt I} & \cellcolor{ccorange}{\color[HTML]{FFFFFF}Roosevelt Ii} \\ \hline
...
\multicolumn{1}{|V{.2\columnwidth}|}{\cellcolor{ccorangelight}Interior Compactor Replacement}          &                                                                  &                                                                  \\
        \multicolumn{1}{|r|}{\cellcolor{ccorangelight}\textit{Status}}                & Completed                                                         & Completed                                                         \\
