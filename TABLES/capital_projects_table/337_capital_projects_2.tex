        ...
        \cline{2-2}
        \multicolumn{1}{l|}{}                                                        & \cellcolor{ccorange}{\color[HTML]{FFFFFF}Lower East Side Ii} & \cellcolor{ccorange}{\color[HTML]{FFFFFF}Lower East Side Rehab (Group 5)} \\ \hline
...
\multicolumn{1}{|V{.2\columnwidth}|}{\cellcolor{ccorangelight}Enlarged Hopper Doors}          &                                                                  &                                                                  \\
        \multicolumn{1}{|r|}{\cellcolor{ccorangelight}\textit{Status}}                & Canceled                                                         & Canceled                                                         \\
