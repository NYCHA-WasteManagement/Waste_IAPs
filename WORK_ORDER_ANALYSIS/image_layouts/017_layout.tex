\begin{center}
                                ...
                                \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Consolidation_BarCharts/png/17_Johnson_WorkOrder_Category_BarChart.png}} \\
                                \end{supertabular}
\end{center}
                        ...
                        \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Dev_Interior_Comp_Repair_BarCharts/png/Johnson_17_Johnson_17_Interior_Comp_Rep_BarChart.png}} \\
                        ...
                        \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Dev_Exterior_Comp_Repair_BarCharts/png/Johnson_17_Johnson_17_Exterior_Comp_Rep_BarChart.png}} \\
                                    \end{supertabular}
                                    \end{center}
