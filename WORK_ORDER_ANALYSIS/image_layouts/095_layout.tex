\begin{center}
                                ...
                                \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Consolidation_BarCharts/png/95_Linden_WorkOrder_Category_BarChart.png}} \\
                                \end{supertabular}
\end{center}
                        ...
                        \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Dev_Interior_Comp_Repair_BarCharts/png/Linden_95_Linden_95_Interior_Comp_Rep_BarChart.png}} \\
                                    \end{supertabular}
                                    \end{center}
                        ...
                        \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Dev_Exterior_Comp_Repair_BarCharts/png/Linden_95_Linden_95_Exterior_Comp_Rep_BarChart.png}} \\
                                    \end{supertabular}
                                    \end{center}
