\begin{center}
                                ...
                                \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Consolidation_BarCharts/png/20_Lincoln_WorkOrder_Category_BarChart.png}} \\
                                \end{supertabular}
\end{center}
                        ...
                        \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Dev_Interior_Comp_Repair_BarCharts/png/Lincoln_20_Lincoln_20_Interior_Comp_Rep_BarChart.png}} \\
                        ...
                        \multicolumn{2}{c}{\includegraphics[width=0.6\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Dev_Exterior_Comp_Repair_BarCharts/png/Lincoln_20_Lincoln_20_Exterior_Comp_Rep_BarChart.png}} \\
                                    \end{supertabular}
                                    \end{center}
