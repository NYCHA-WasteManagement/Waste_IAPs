\begin{figure}[h]
                                ...
                                \includegraphics{\rootpath/WORK_ORDER_ANALYSIS/Consolidation_BarCharts/png/359_Kraus-Management-(MB-1)_WorkOrder_Category_BarChart.png}
                                \end{subfigure}
                                \begin{subfigure}{0.45\textwidth}
                                        \includegraphics[width=\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Development_BarCharts/png/359_154-WEST-84TH-STREET_WorkOrder_Category_BarChart.png}
                                        \end{subfigure}
                                        \begin{subfigure}{0.45\textwidth}
                                        \includegraphics[width=\textwidth]{\rootpath/WORK_ORDER_ANALYSIS/Development_BarCharts/png/516_REHAB-PROGRAM-(TAFT-REHABS)_WorkOrder_Category_BarChart.png}
                                        \end{subfigure}
                                        \end{figure}
\begin{figure}[h]
                                \raggedright
