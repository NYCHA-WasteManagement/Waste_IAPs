\chapter{Preface}
    ...
    Below is a list of West Brighton Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Gloria Fields
    \item Superintendent: Eva Gonzalez
    \end{itemize}
    }