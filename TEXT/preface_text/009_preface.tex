\chapter{Preface}
    ...
    Below is a list of East River Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Angela Gadson-Floyd
    \item NGO1 Borough Director: Darrell Laval
    \item Regional Asset Manager: Tasha Turner
    \item Property Manager: Alfred Rawlins
    \item Superintendent: Danny Matos
    \end{itemize}
    }