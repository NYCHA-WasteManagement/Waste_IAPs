\chapter{Preface}
    ...
    Below is a list of Carey Gardens Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Brooklyn Borough Director: VACANT
    \item Regional Asset Manager: Michael Iezza
    \item Property Manager: Ronald Cholewa
    \item Superintendent: David Rios
    \end{itemize}
    }