\chapter{Preface}
    ...
    Below is a list of Borinquen Plaza Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Brooklyn Borough Director: VACANT
    \item Regional Asset Manager: Alicia Maynard
    \item Property Manager: Margie Taylor
    \item Superintendent: Carlos Gonzalez
    \end{itemize}
    }