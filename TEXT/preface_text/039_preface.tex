\chapter{Preface}
    ...
    Below is a list of Pelham Parkway Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Luba Sato
    \item Superintendent: Christopher Sands
    \end{itemize}
    }