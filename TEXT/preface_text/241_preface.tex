\chapter{Preface}
    ...
    Below is a list of Jackie Robinson Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Hector Hernandez
    \item Superintendent: Haydee Ortiz
    \end{itemize}
    }