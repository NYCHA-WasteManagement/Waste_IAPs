\chapter{Preface}
    ...
    Below is a list of La Guardia Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Miata Dorley
    \item Superintendent: Paula Davenport
    \end{itemize}
    }