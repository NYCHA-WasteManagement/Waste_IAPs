\chapter{Preface}
    ...
    Below is a list of Bronx River Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Sunny Vellavallil
    \item Superintendent: Joacim Mendez
    \end{itemize}
    }