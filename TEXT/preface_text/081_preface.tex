\chapter{Preface}
    ...
    Below is a list of Manhattanville Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Mixed Finance Borough Director: Carl Walton
    \item Regional Asset Manager: Anthony Dingle
    \item Property Manager: Janine Rodriquez
    \item Superintendent: Iris Perez
    \end{itemize}
    }