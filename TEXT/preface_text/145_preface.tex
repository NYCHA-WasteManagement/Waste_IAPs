\chapter{Preface}
    ...
    Below is a list of Mitchel Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Edward Adeyanju
    \item Superintendent: Harrison Torres
    \end{itemize}
    }