\chapter{Preface}
    ...
    Below is a list of Latimer Gardens Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Queens/Staten Island Borough Director: Cesar Gonzalez
    \item Regional Asset Manager: Neagia Drew
    \item Property Manager: Chemparathil Thomas
    \item Superintendent: Robert Buonacore
    \end{itemize}
    }