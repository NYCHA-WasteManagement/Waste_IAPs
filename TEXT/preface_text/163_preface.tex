\chapter{Preface}
    ...
    Below is a list of Wyckoff Gardens Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Brooklyn Borough Director: VACANT
    \item Regional Asset Manager: Alverista Hall
    \item Property Manager: Shelisa Reid
    \item Superintendent: Beana Alston
    \end{itemize}
    }