\chapter{Preface}
    ...
    Below is a list of Throggs Neck Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Chukwuma Ndukah
    \item Superintendent: Louis Bevilacqua
    \end{itemize}
    }