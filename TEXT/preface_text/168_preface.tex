\chapter{Preface}
    ...
    Below is a list of Langston Hughes Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Angela Gadson-Floyd
    \item NGO1 Borough Director: Darrell Laval
    \item Regional Asset Manager: Andrew Korbul
    \item Property Manager: Michelle McGill-Felix
    \item Superintendent: Diana Legree
    \end{itemize}
    }