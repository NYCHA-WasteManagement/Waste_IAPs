\chapter{Preface}
    ...
    Below is a list of Morrisania Air Rights Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Angela Gadson-Floyd
    \item Bronx Borough Director: Theresa Bethea
    \item Regional Asset Manager: Theresa Bethea
    \item Property Manager: Linda Best
    \item Superintendent: VACANT (Timothy Johnson -- Floater)
    \end{itemize}
    }