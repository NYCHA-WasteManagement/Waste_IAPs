\chapter{Preface}
    ...
    Below is a list of South Jamaica Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Natasha Davis
    \item Superintendent: Juan Mercado
    \end{itemize}
    }