\chapter{Preface}
    ...
    Below is a list of Boulevard Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Mixed Finance Borough Director: Carl Walton
    \item Regional Asset Manager: Jacqueline Hipps
    \item Property Manager: Johnson Varughese
    \item Superintendent: Kofi Amoh-Tonto
    \end{itemize}
    }