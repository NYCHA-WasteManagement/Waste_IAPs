\chapter{Preface}
    ...
    Below is a list of Taylor -Wythe  Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Teri Dawson
    \item Superintendent: Celeste Hawkes
    \end{itemize}
    }