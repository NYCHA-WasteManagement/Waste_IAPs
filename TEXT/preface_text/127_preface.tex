\chapter{Preface}
    ...
    Below is a list of Wise Towers Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Mixed Finance Borough Director: Carl Walton
    \item Regional Asset Manager: Carl Walton
    \item Property Manager: Latoya Hansley
    \item Superintendent: Mary Glenn
    \end{itemize}
    }