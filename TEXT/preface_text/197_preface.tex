\chapter{Preface}
    ...
    Below is a list of Fort Independence Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Jasmine Williams
    \item Superintendent: Kim Vereen
    \end{itemize}
    }