\chapter{Preface}
    ...
    Below is a list of Stuyvesant Gardens Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Brooklyn Borough Director: VACANT
    \item Regional Asset Manager: Renee Taylor
    \item Property Manager: Michael Lawrence
    \item Superintendent: Tuesdai Gaskin
    \end{itemize}
    }