\chapter{Preface}
    ...
    Below is a list of Richmond Terrace Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    ...
    \item Property Manager: Kamal Hossain
    \item Superintendent: Manuel Garcia
    \end{itemize}
    }