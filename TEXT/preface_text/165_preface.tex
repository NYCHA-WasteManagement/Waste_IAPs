\chapter{Preface}
    ...
    Below is a list of Beach 41St Street-Beach Channel Drive Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Queens/Staten Island Borough Director: Cesar Gonzalez
    \item Regional Asset Manager: Carlos Falu
    \item Property Manager: Menthal Alexander
    \item Superintendent: Jorge Almodovar
    \end{itemize}
    }