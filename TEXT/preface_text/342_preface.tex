\chapter{Preface}
    ...
    Below is a list of Union Avenue Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Angela Gadson-Floyd
    \item Bronx Borough Director: Theresa Bethea
    \item Regional Asset Manager: Kim Theodore
    \item Property Manager: Robin Reed
    \item Superintendent: Tamisha Waiters
    \end{itemize}
    }