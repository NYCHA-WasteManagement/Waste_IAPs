\chapter{Preface}
    ...
    Below is a list of Pennsylvania Avenue-Wortman Avenue Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Joseph Courtien
    \item Brooklyn Borough Director: VACANT
    \item Regional Asset Manager: Michael Iezza
    \item Property Manager: Jia Feng Wu
    \item Superintendent: Lois Kelly
    \end{itemize}
    }