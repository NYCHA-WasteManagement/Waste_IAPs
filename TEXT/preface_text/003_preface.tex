\chapter{Preface}
    ...
    Below is a list of Harlem River Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Angela Gadson-Floyd
    \item Manhattan Borough Director: Octavia Hayward
    \item Regional Asset Manager: Albert Suggs
    \item Property Manager: Maria Sanchez
    \item Superintendent: Risha Barnett
    \end{itemize}
    }