\chapter{Preface}
    ...
    Below is a list of Mill Brook Consolidated Management Personnel as of August 2020:
    \begin{itemize}
    \item Operations VP: Angela Gadson-Floyd
    \item NGO1 Borough Director: Darrell Laval
    \item Regional Asset Manager: Samantha McMillan
    \item Property Manager: Fredericka Dilworth
    \item Superintendent: Charles Starks
    \end{itemize}
    }